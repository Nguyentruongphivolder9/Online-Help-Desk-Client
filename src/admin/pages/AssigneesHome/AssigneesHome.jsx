            ...
            <div className='flex h-full flex-row w-full border border-x-gray-300'>
              <div className='h-full w-1/5 overflow-hidden'>
                ...
                {isShowResultSearch ? (
                  ...
                  <div className='h-10/12 relative w-full text-sm'>
                    <div className='flex flex-row justify-center w-full p-[10px] border-b-4 border-solid border-blue-500 text-blue-700' >
                      Requests
                    </div>
              ...
              <div id="main-content" className="h-full w-3/5 p-[10px] relative overflow-y-scroll hide-scrollbar border-x border-x-gray-300">
                <div className='h-full w-full bg-slate-300 rounded-md drop-shadow-lg'>
              ...
              <div className='relative text-gray-700 z-20 h-full top-0 flex lg:flex flex-shrink-0 flex-col w-1/5 transition-width duration-75'>
                <div className='w-full h-1/2 pt-[10px] border-y border-solid'>
                  <div className='h-7 px-[10px] text-lg font-semibold text-gray-600'>
                    Notification
                  </div>
