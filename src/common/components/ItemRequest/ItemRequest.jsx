...
export default function ItemRequest({ dataItem }) {
  return (
    <div onClick={() => console.log("click request")} className='h-28 w-full p-[10px] flex flex-row border-y border-solid border-gray-300 bg-cyan-100'>
      ...
      <div className='h-full w-10/12 flex flex-row'>
        ...
        <div className='w-1/5 h-full text-gray-500 text-xs '>
          <div className='w-full h-2/4 italic'>
            5min ago
          </div>
          <div className='w-5 h-2/4 flex items-center justify-center'>
